...
export default function TrucksNew() {
  ...
  if (!hasBaseLocation) {
    return (
      <div className="relative isolate min-h-[500px] lg:min-h-[calc(100vh-140px)] flex flex-col overflow-hidden">
        ...
        {/* Bandeau pizzaiolo mobile - en haut */}
        <div className="sm:hidden px-4 pt-4">
          <button
            type="button"
            onClick={() => navigate('/pro/inscription')}
            className="group w-full rounded-2xl bg-gradient-to-r from-orange-500 to-orange-600 p-4 text-white shadow-lg active:scale-[0.99] transition-all"
          >
            <div className="flex items-center gap-3">
              <span className="flex h-10 w-10 items-center justify-center rounded-full bg-white/20 text-xl">🍕</span>
              <div className="text-left">
                <p className="font-bold text-base">Vous êtes pizzaiolo ?</p>
                <p className="text-white/90 text-sm">Gérez vos commandes — <span className="font-black underline underline-offset-2">100% gratuit</span></p>
              </div>
            </div>
          </button>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center px-6">
          <div className="w-full max-w-4xl space-y-12 py-12 sm:py-20 relative overflow-visible z-30">
          ...
          {/* Bandeau pizzaiolo desktop - en bas */}
          <button
            type="button"
            onClick={() => navigate('/pro/inscription')}
            className="hidden sm:block group w-full rounded-2xl bg-gradient-to-r from-orange-500 to-orange-600 p-5 text-white shadow-lg hover:shadow-xl hover:scale-[1.01] active:scale-[0.99] transition-all"
          >
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-3">
                <span className="flex h-10 w-10 items-center justify-center rounded-full bg-white/20 text-xl">🍕</span>
                <div className="text-left">
                  <p className="font-bold text-lg">Vous êtes pizzaiolo ?</p>
              ...
              <span className="flex items-center gap-1 font-semibold text-sm bg-white/20 rounded-full px-4 py-2 group-hover:bg-white/30 transition-colors">
                Commencer
